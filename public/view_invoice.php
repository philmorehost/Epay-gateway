    ...
    <div class="card-body">
                ...
                <table class="table table-clear">
                    <tbody>
                        ...
                        <tr class="table-primary">
                            ...
                            <td class="right">
                                <strong>NGN <?php echo number_format($invoice['total'], 2); ?></strong>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <?php if ($invoice['status'] == 'Unpaid'): ?>
            <div class="text-center mt-4 p-4 border rounded bg-light">
                ...
                <button class="btn btn-lg btn-success">Pay with Paystack (USD)</button>
                <!-- Add other manual payment method details here -->
            </div>
